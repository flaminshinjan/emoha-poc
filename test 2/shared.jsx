...
const ADVISORS = [
  { slug: "priya", name: "Priya", role: "Calm, unhurried", desc: "Best for when you need someone to listen first.", color: "#3b6a63" },
  { slug: "asha", name: "Asha", role: "Practical, grounded", desc: "Best when you want to get to clarity quickly.", color: "#8a6f3f" },
  { slug: "devi", name: "Devi", role: "Hindi + English", desc: "Switches naturally if your parent is more comfortable in Hindi.", color: "#7a4f6b" },
];
